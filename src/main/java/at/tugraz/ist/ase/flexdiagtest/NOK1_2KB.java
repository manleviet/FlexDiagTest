...
@Slf4j
public class NOK1_2KB extends KB {

    public NOK1_2KB() {
        super("NOK1_2", "Siemens NOK1_2", false);
    ...
    private void constraintGroup4() {
        ...
        // Constraint 55 - dppm_vmakespan.le(6).post();
        startIdx = modelKB.getNbCstrs();
        modelKB.arithm(((IntVariable)variableList.get(17)).getChocoVar(), ">=", 6).post();

        addConstraint("Constraint 54 - dppm_vmakespan.le(6).post();",
                startIdx);
    }
