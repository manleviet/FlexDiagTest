...
/**
 * Only use when kb is NOK1_3KB
 * C contains 15 constraints
 */
@Slf4j
public class NOKModel_13 extends CDRModel implements IChocoModel {

    @Getter
    private final Model model;
    private final KB kb;

    public NOKModel_13(KB kb) {
        super("kb");
